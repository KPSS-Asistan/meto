...
/// Favoriler sayfası - Açılır/kapanır soru listesi
...
class _FavoritesPageState extends State<FavoritesPage> {
  ...
  Future<void> _loadFavorites() async {
    final favorites = await UserDataService.getFavorites();
    ...
    final questions = await repo.getQuestionsByIds(favorites.toList());
  ...
  Future<void> _removeFavorite(String questionId) async {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Soru çözerken beğendiğiniz soruları\nfavorilere ekleyebilirsiniz',
